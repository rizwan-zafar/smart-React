            ...
            <div className="container">
                ...
                <ul className=" nav  nav-fill">
                    ...
                    <li className={`nav-item ${isBrandingActive}`} onClick={() => { handleFilter("branding") }}>
                        Branding                    </li>
                    <li className={`nav-item ${isBrandingActive}`}onClick={() => { handleFilter("marketing") }}>
                        Marketing                    </li>
                    <li className={`nav-item ${isBrandingActive}`} onClick={() => { handleFilter("planning") }}>
                        Planning
                    </li>
                    <li className={`nav-item ${isBrandingActive}`} onClick={() => { handleFilter("research") }}>
                        Research
                    </li>
