...
export default function Portfolio() {
    ...
    const [isAllWorkActive,setAllWorkActive]=React.useState(true)
    const [isBrandingActive,setBrandingActive]=React.useState(true)
    const [isMarketingActive,setMarketingActive]=React.useState(true)
    const [isPlanningActive,setPlanningActive]=React.useState(true)
    const [isResearchActive,setResearchActive]=React.useState(true)
    /*
     * Filer Array
     @ params string
    */
