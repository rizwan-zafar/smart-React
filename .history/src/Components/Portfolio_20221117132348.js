...
export default function Portfolio() {
    ...
    const [portfolio,setPortfolio]=React.useState(por)
    const handleFilter = (value) => {
      const data=portfolio.filter(item=>item.type===value)
      console.log(data)
    }
    return (
        <div className='portfolio'>
            ...
            <div className="container">
                ...
                <ul className=" nav  nav-fill">
                    <li className="nav-item active" aria-current="page" onClick={() => { handleFilter("all work") }}>
                        All Work
                     </li>
