...
export default function Navbar() {
    ...
    const handleHumBurger = (hamburgerIcon) => {
     ...
     return (
        <div className="NavContainer position-fixed">
            <nav className="navbar navbar-expand-lg navbar-dark">
                <div className="container">
                    <a className="navbar-brand" href="/">
                        <img className="img-fluid" src="Images/logo.png" alt="not found" />
                    </a>
                    <div className="navbar-toggler" type="button" data-bs-toggle="collapse"   onClick={() => { handleHumBurger(hamburgerIcon) }} data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
